...
const Navbar = () => {
  ...
  if (viewNav)
    return (
      <div className=" hidden w-full lg:flex items-center justify-center fixed animate-nav top-0  bg-gradient-to-t backdrop-blur-[2px] from-[#051009]/10 to-black/10  z-[999]">
